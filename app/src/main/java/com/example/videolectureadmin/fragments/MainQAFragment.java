...
public class MainQAFragment extends Fragment {
    ...
    public static MainQAFragment newInstance(String param1, String param2) {
        MainQAFragment fragment = new MainQAFragment();
                    ...
                    if (isComplete) {
                        if (workName.trim().equalsIgnoreCase("no")) {
                            ...
                            if (arrayList != null) {
                                ...
                                SubCategoryAdapter categoryAdapter = new SubCategoryAdapter(context, arrayList);
