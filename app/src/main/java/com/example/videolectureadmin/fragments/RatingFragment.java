...
import com.example.videolectureadmin.adapter.RatingAdapter;
...
public class RatingFragment extends Fragment {
    ...
    private void gtUsersList() {
        ...
        if (Utility.isOnline(context)) {
            ...
            serviceCaller.callAllRatingData(new IAsyncWorkCompletedCallback() {
                @Override
                public void onDone(String workName, boolean isComplete) {
                    dialog.dismiss();
                    if (isComplete) {
                        if (workName.trim().equalsIgnoreCase("no")) {
                            Toasty.error(context, "Any Rating Not Found", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            if (arrayList != null) {
                                ...
                                RatingAdapter categoryAdapter = new RatingAdapter(context, arrayList);
